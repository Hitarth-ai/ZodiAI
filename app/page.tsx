...
export default function Chat() {
  ...
  function handleBirthSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    const text = `My name is ${name}. My date of birth is ${day}-${month}-${year} at ${safeHour}:${safeMinute} (approx). I was born in ${place}. Please use Vedic astrology to interpret my chart and give me an overview of my personality, strengths, challenges, and current focus areas.`;
